    ...
    <div className="w-full">
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="w-full pl-10 pr-12 py-2 bg-terrain-50 border border-terrain-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-forest-500 focus:border-transparent placeholder-trail-400"
        />
      ...
      {/* Filter Options - Always visible below search */}
      <div className="mt-3 bg-terrain-100 rounded-lg border border-terrain-300 p-4" style={{ backgroundColor: '#faf8f5' }}>
